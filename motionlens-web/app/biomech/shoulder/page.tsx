          ...
          <div className="mt-12 space-y-12">
            ...
            <section>
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <Link
                  href={`/biomech/shoulder/live?movement=${movement ?? ""}&side=${side ?? ""}${patientQS}`}
                ...
                <Link
                  href={`/biomech/shoulder/upload?movement=${movement ?? ""}&side=${side ?? ""}${patientQS}`}
                  className={`rounded-card border p-6 transition ${
                    canProceed
                      ? "border-border bg-surface hover:border-accent"
                      : "pointer-events-none border-border/50 bg-surface/40 opacity-50"
