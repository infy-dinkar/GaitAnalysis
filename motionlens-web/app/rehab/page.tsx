...
const MODULES: RehabModule[] = [
  ...
  },
  {
    ...
    title: "Hold & control",
    body:
      "Isometric holds turned into a game — patient drives a marker into a target band and keeps it there. Knee-extension holds, glute bridges, wall sits.",
    icon: Timer,
  ...
  },
  {
    ...
    title: "Reach further",
    body:
      "Targets spawn around the play area; the patient drives a body-anchored cursor onto them. Tracks max excursion as a functional-range signal.",
    icon: Target,
  ...
  },
  {
    ...
    title: "Smooth trace",
    body:
      "A lead target glides along a path; the patient's cursor stays glued to it. Scores per-sample accuracy AND smoothness (jerk magnitude).",
    icon: Spline,
  ...
  },
  {
    ...
    body:
      "Lateral weight-shift training with anti-cheat — the moment a step is detected, dwell auto-pauses. Forces real medio-lateral COM control.",
    icon: Footprints,
    iconTone: "text-teal-500",
    tone: "from-teal-500/15 to-teal-500/5",
    href: null,
