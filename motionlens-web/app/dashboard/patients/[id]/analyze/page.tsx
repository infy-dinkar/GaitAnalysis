...
const MODULES = [
  ...
  },
  {
    ...
    title: "Squat (Lateral)",
    body: "Sagittal-plane squat — side-on single camera. Two metrics at the deepest rep: peak knee flexion + peak hip flexion. Near-side leg only. Trunk lean, hip:knee ratio, heel rise, ankle dorsiflexion, and frontal-plane valgus intentionally not scored — the 2D lateral proxies were too noisy in practice. Use Overhead Squat or Single-Leg Squat for valgus.",
    icon: MoveRight,
    tone: "from-teal-500/15 to-teal-500/5",
    iconTone: "text-teal-600",
  },
