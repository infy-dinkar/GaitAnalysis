...
const PRODUCTS = [
  ...
  },
  {
    ...
    body:
      "Shoulder and neck assessment with peak angle tracking, target ranges, and instant good/fair/poor classification. Live or upload.",
    gradient:
  ...
  return (
    <Section id="modules" className="bg-dots">
      <div className="max-w-2xl">
        <Badge>Two modules</Badge>
        <h2 className="mt-5 text-3xl font-semibold tracking-tight md:text-5xl">
          Movement, measured<br />two ways.
        </h2>
      </div>
