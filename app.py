...
def _render_graphs(features: dict) -> None:
    ...
    descriptions = {
        "knee": "**Understanding this graph:** This graph tracks the flexion (bending) angle of your left and right knees over time. The grey shaded band represents the typical healthy knee flexion range during a walking stride (120°–160°). Trajectories consistently falling outside this band may indicate stiffness or hyper-extension.",
