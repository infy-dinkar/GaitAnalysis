...
from backend.engines.shoulder_engine import SHOULDER_NORMAL_RANGES, compute_shoulder_angle
from backend.engines.neck_engine import NECK_NORMAL_RANGES, compute_neck_angle
from backend.streamlit.biomech_flow import (
...
from backend.engines.tug_engine import analyze_tug
from backend.engines.tug_models import TUGResponse

# ─── Ankle (dorsi/plantar) — reuses gait MediaPipe pipeline ──────
from backend.engines.ankle_engine import analyze_ankle as analyze_ankle_engine

# ─── SPPB Component 1 (Balance) — reuses gait MediaPipe pipeline ─
from backend.engines.sppb_balance_engine import analyze_sppb_balance
...
from backend.patients.routes import router as patient_router
from backend.reports.routes import (
...
async def analyze_ankle(
    ...
    from backend.engines.tug_engine import _ensure_decodable_video
